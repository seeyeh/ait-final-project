...
const deleteUser = asyncHandler(async (req,res) => {
    ...
    if (!username) {  // Request must have an ID bc we need ID to find the User document to delete
    ...
    const result = await user.deleteOne().exec() // deletes User document; result holds deleted user's information
