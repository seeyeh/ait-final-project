...
function DashHome() {
  return (
    <div className="flex flex-wrap gap-x-12 gap-y-6">
      <div className="w-full lg:w-[calc(50%-1.5rem)] flex flex-col gap-6">
        <h1 className="text-7xl">
          Saturday,
          <br /> December 25
        </h1>
        <LabeledSection label="This Week" color="green">
          <h2>This Week</h2>
        ...
        <LabeledSection label="Workouts" color="pink">
      ...
      <div className="w-full lg:w-[calc(50%-1.5rem)] flex flex-col gap-6">
        <LabeledSection label="Log" color="yellow">
        ...
        <LabeledSection label="Stats" color="blue">
